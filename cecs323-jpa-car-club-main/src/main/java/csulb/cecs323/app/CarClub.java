...
public class CarClub {
   ...
   public static void main(String[] args) {
      ...
      // New owners
      owners.add(new Owners("Leilani", "Cardenas", "424-456-7890"));
      owners.add(new Owners("Jackie", "Brown", "424-800-1234"));
      owners.add(new Owners("Joseph", "Villanueva", "424-321-8765"));

      // Giving each owner at least 2 cars
      cars.add(new Cars(owners.get(3), carclub.getStyle("coupe"), "85263850", "Toyota", "Tercel", 1989));
      cars.add(new Cars(owners.get(3), carclub.getStyle("sedan"), "34792053", "Volkswagen", "Jetta", 2017));
      cars.add(new Cars(owners.get(4), carclub.getStyle("sedan") , "27592035", "Honda", "Civic", 2007));
      cars.add(new Cars(owners.get(4), carclub.getStyle("sports car") , "17146114", "BMW", "M5", 2022));
      cars.add(new Cars(owners.get(5), carclub.getStyle("sedan"), "74569103", "Honda", "Civic", 2022));
      cars.add(new Cars(owners.get(5), carclub.getStyle("hatchback"), "83575923", "Volkswagen", "Golf", 2015));
